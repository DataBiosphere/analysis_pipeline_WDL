# run before prepare_segments_1.py
...
cp ../../_test-data-and-truths_/assoc/1KG_phase3_subset_chr12.gds .
...
cp ../../_test-data-and-truths_/assoc/aggregate_list_chr12.RData .
...
cp ../../_test-data-and-truths_/assoc/variant_include_chr12.RData .
